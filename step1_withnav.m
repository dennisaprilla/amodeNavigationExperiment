...
is_saving = true;
LABEL_1   = "withnav-raw";
LABEL_2   = "withnav-cleaned";
LABEL_3   = "withnav-windowupdated";
filelabel = LABEL_3;
...
if(strcmp(filelabel, LABEL_1))
    groups = [ "A_F_GTR", ...
               ...
               "A_T_MID", ...
               "A_T_MAL"];
elseif(strcmp(filelabel, LABEL_2))
    ...
    groups = [ "A_F_GTR_windowupdated", ...
               "A_F_MID_windowupdated", ...
               "A_F_LEP_windowupdated", ...
               "A_F_MEP_windowupdated", ...
               "A_T_LEP_windowupdated", ...
               "A_T_MEP_windowupdated", ...
               "A_T_MID_windowupdated", ...
               "A_T_MAL_windowupdated"];
end
...
for group_idx=1:n_groups
    ...
    for rbdata_idx=1:n_observation
        ...
        % 3.2) get the signal sample that is inside the window
        ...
        % 4.1) plot 3d signal outside the window
        ...
        % 4.2) plot 3d signal inside the window
        ...
        % 4.3) plot the text label for each signal
        text( ax1{group_idx},...
        ...
        probe(rbdata_idx).timestamp = current_grouprigidbody(rbdata_idx).Timestamp;
